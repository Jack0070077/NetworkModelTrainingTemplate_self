...
from my_modules.ResNet_1x128x128 import resnet20

# -------------------------------------------- Params Setting -------------------------------------------------- #
batch_size = 128
lr = 5e-4
l2_alpha = 5e-2
EPOCH, start_epoch, is_pretrained = 50, 0, False
net = resnet20()
...
scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer=optim_fn, T_max=120, eta_min=0.001 * lr, last_epoch=start_epoch - 1)  # 余弦退火
